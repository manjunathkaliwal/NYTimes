...
class NewsListViewController: UIViewController,UISearchBarDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if  segue.identifier == String(describing: NewsDetailViewController.self) ,let destination = segue.destination as? NewsDetailViewController{
...
extension NewsListViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        self.performSegue(withIdentifier: String(describing: NewsDetailViewController.self), sender: indexPath)
    }
...
extension NewsListViewController: ViewModelDelegate {
